...
usage:
	...
	pr_msg("\n"
	       ...
	       "  --ghost-links         dump unlinked-but-open files as ghosts instead of\n"
	       "                        link-remaps, producing a self-contained image that\n"
	       "                        can be restored on a different filesystem (fanout)\n"
